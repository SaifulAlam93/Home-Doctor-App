        ...
        <section>
            <nav>
                <ul>
                    ...
                    <br/>
                    <li><a href="add_drags_form" >Add Drags form</a></li>
                    <br>
                    <li><a href="add_dosage_form" >Add Dosage form</a></li>
                    <br>
                    <li><a href="add_patient_form" >Add Patient form</a></li>
                    <br>
                    <li><a href="add_doctor_form" >Add Doctor form</a></li>
